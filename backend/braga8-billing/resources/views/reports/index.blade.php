    ...
    <div class="flex flex-col gap-6"> 
        ...
        <div class="card-image-container mb-2"> 
            <div class="card card-with-image"> 
                ...
                <div class="card-body"> 
                    ...
                    <p class="card-value">Rp {{ $latestReport ? number_format($latestReport->total_revenue_expected, 0, ',', '.') : '0' }}</p> 
                </div> 
            </div> 
            <div class="card card-with-image"> 
                <div class="card-image"></div> 
                <div class="card-body"> 
                    ...
                    <p class="card-value">{{ $latestReport ? number_format($latestReport->total_electric_usage) : '0' }} <span class="text-xs font-normal">kWh</span></p> 
                </div> 
            </div> 
            <div class="card card-with-image"> 
                <div class="card-image"></div> 
                <div class="card-body"> 
                    ...
                    <p class="card-value">{{ $latestReport ? number_format($latestReport->total_water_usage) : '0' }} <span class="text-xs font-normal">m³</span></p> 
                </div> 
            </div> 
        </div> 
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4 px-2"> 
            <div class="text-sm text-zinc-500"> 
                Showing <span class="text-white">{{ $reports->firstItem() }}</span> to <span class="text-white">{{ $reports->lastItem() }}</span> of <span class="text-white">{{ $reports->total() }}</span> results 
            </div> 
