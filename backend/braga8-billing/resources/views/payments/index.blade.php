...
@if (session('status'))
    @php
        $alerts = [
            'payment-stored' => [
                ...
                'desc'  => 'Data pembayaran baru berhasil disimpan.',
                'icon'  => 'fa-circle-check'
            ],

            'payment-updated' => [
                'title' => 'Pembayaran Diperbarui!',
                'desc'  => 'Perubahan pembayaran berhasil disimpan.',
                'icon'  => 'fa-pen-to-square'
            ],

            'payment-deleted' => [
                'title' => 'Pembayaran Dihapus!',
                'desc'  => 'Riwayat pembayaran berhasil dihapus.',
                'icon'  => 'fa-trash-can'
            ],

            'profile-updated' => [
                'title' => 'Profil Diperbarui!',
                'desc'  => 'Informasi akun berhasil diperbarui.',
                'icon'  => 'fa-user-check'
            ],
            ...
            'remind-cooldown' => [
                ...
                'desc'  => 'Pengingat sudah dikirim sebelumnya.',
                'icon'  => 'fa-clock'
            ],
    ...
    @if ($current)
        <div 
            id="universal-alert"
            class="fixed top-6 right-6 z-[9999] flex items-center justify-between p-5 min-w-[380px] text-white border border-white/20 rounded-2xl bg-[#602316] shadow-[0_10px_40px_rgba(0,0,0,0.7)] transition-all duration-500"
        >
...
<div class="min-h-screen">
                            ...
                            <div class="popup" id="edit-payment-{{ $payment->id }}">
                                ...
                                <div class="popup-card popup-md">
                                    ...
                                    <div class="popup-body">
                                        ...
                                        @if ($errors->any())
                                        <div class="mb-6 overflow-hidden rounded-xl border border-red-500/20 bg-red-500/5 text-left">
                                            <div class="flex items-center gap-3 bg-red-500/10 px-4 py-2 border-b border-red-500/10">
                                                <i class="fa-solid fa-circle-exclamation text-red-500 text-xs"></i>
                                                <span class="text-[11px] font-bold uppercase tracking-wider text-red-500">Input Tidak Valid</span>
                                            </div>
                                            <div class="p-4">
                                                <ul class="flex flex-col gap-1.5">
                                                    @foreach ($errors->all() as $error)
                                                    <li class="text-[12px] text-red-400/80 flex items-center gap-2">
                                                        <span class="h-1 w-1 rounded-full bg-red-500/40"></span>
                                                        {{ $error }}
                                                    </li>
                                                    @endforeach
                                                </ul>
                                            ...
                                            <div class="flex flex-col gap-6">
                                                <div>
                                                        ...
                                                        <div class="text-field">
                                                            ...
                                                            <div class="custom-dropdown">
                                                                <div class="dropdown-selected">
                                                                    ...
                                                                    <i class="fa-solid fa-angle-down arrow text-zinc-500"></i>
                                                                </div>
                                                    ...
                                                    <div class="text-field">
                                                        ...
                                                        <div class="mb-2 flex items-center gap-3">
                                                            <img id="preview-img-{{ $payment->id }}" src="{{ asset('storage/' . $payment->proof_img) }}" class="w-18 h-18 object-cover rounded-lg border border-zinc-400">
                                                            <span class="text-[10px] text-zinc-500 italic">Gambar saat ini</span>
                                                        </div>
                                                        @endif
                                                        <input type="file" name="proof_img" onchange="previewImage(this, '{{ $payment->id }}')" class="text-xs file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-xs file:font-semibold file:bg-zinc-100 file:text-zinc-700 hover:file:bg-zinc-200 cursor-pointer w-full text-zinc-400">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex gap-3 mt-2">
                                                    ...
                                                    <button type="submit" class="dark-brown-button flex-[2] py-3">
                                                        <i class="fa-solid fa-rotate mr-2"></i> Perbarui Pembayaran
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
    ...
    <div class="popup" id="add-payment-modal">
        ...
        <div class="popup-card popup-md">
            <div class="popup-close-wrapper">
                <button class="popup-close" data-close="add-payment-modal">
                    <i class="fa-solid fa-xmark"></i>
                </button>
            </div>
                ...
                <form action="{{ route('payments.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="text-field">
                            ...
                            <div class="custom-dropdown" id="invoiceDropdown">
                                <div class="dropdown-selected">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="text-field">
                                <label class="text-field-label text-left">Jumlah Bayar</label>
                                <input type="number" name="amount_paid" id="modal_amount_paid" class="text-field-input" placeholder="0" required step="any">
                                <p class="text-[9px] text-zinc-500 mt-1 italic text-left" id="modal_min_label">Pilih invoice untuk melihat total.</p>
                            </div>
                            <div class="text-field">
                                <label class="text-field-label text-left">Tanggal Bayar</label>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="text-field">
                                ...
                                <div class="custom-dropdown">
                                    <div class="dropdown-selected">
                                        <span class="placeholder">Bank Transfer</span>
                                        <i class="fa-solid fa-angle-down arrow text-zinc-500"></i>
                                    </div>
                                    <div class="dropdown-options">
                                        {{-- Sesuai value asli: Bank Transfer, Cash, E-Wallet --}}
                                        <div class="option">Bank Transfer</div>
                                        <div class="option">Cash</div>
                                        <div class="option">E-Wallet</div>
                                    </div>
                            ...
                            <div class="text-field">
                                ...
                                <div class="custom-dropdown">
                                    <div class="dropdown-selected">
                                        <span class="placeholder">Pending</span>
                                        <i class="fa-solid fa-angle-down arrow text-zinc-500"></i>
                                    </div>
                                    <div class="dropdown-options">
                                        <div class="option" data-value="pending">Pending</div>
                        ...
                        <div class="text-field">
                            <label class="text-field-label text-left">Unggah Bukti (Gambar)</label>
                        ...
                        <button type="submit" class="dark-brown-button w-full mt-2">
                            Simpan Pembayaran
                        </button>
                    </div>
                </form>
