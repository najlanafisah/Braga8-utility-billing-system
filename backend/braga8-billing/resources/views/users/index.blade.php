    ...
    <div class="flex flex-col gap-6"> 
                        ...
                        <tr> 
                            ...
                            <td class="actions"> 
                                <div class="flex justify-center gap-2"> 
                                    ...
                                    <form id="delete-form-{{ $user->id }}" action="{{ route('users.destroy', $user->id) }}" method="POST" class="m-0 p-0"> 
                                        @csrf 
                                        @method('DELETE') 
                                        <button type="button" class="dark-brown-btn-action border-0" data-popup="delete-user" data-id="{{ $user->id }}" data-name="{{ $user->name }}"> 
                                                        ...
                                                        <div class="text-field"> 
                                                            ...
                                                            <div class="custom-dropdown"> 
                                                                <div class="dropdown-selected"> 
                                                                    <span class="placeholder text-[#131316]"> {{ ucfirst($user->role) }} </span> 
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4 px-2">
            <div class="text-sm text-zinc-500">
                Showing <span class="text-white">{{ $users->firstItem() }}</span> 
                to <span class="text-white">{{ $users->lastItem() }}</span> 
                of <span class="text-white">{{ $users->total() }}</span> results
            </div>
        ...
        <div class="popup-card popup-md"> 
            ...
            <div class="popup-body"> 
                <div class="btn-delete-wrapper flex gap-4"> 
                    ...
                    <button class="dark-brown-button flex-1" data-close="delete-user">Batal</button> 
                </div> 
            </div> 
        </div> 
    </div> 
