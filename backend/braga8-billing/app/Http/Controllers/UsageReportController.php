...
class UsageReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($search) {
            ...
            $monthsMap = [
                ...
                'mei' => '05', 'mei' => '05', 'may' => '05', '05' => '05', '5' => '05',
    ...
    public function generate(Request $request)
    {
        ...
        return redirect()->route('reports.index')->with('success', 'Laporan bulanan periode ' . $formattedDate . ' berhasil dibuat!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('reports.index')->with('success', 'Laporan bulanan periode ' . $formattedDate . ' berhasil dihapus.');
    }
}